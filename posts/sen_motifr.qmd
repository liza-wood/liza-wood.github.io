...
author: "Francesa Vantaggiato & Liza Wood"
date: "August 10, 2024"
description: ""
type: post
toc: TRUE
...
## Create networks and their matrices
...
## The rows should be actors and the columns should be ecological units; if your network is switched, just transpose
...
Now we can build a single network that is our full, multi-level social-ecological network(SEN). We'll first bind together the social and ecological node attributes, and create a new attribute 'sesType', which will be important for specifying levesl in `motifR`. 
