...
[Converting Google Docs to LaTeX template for aggiedoesn](posts/googledoc-aggiedown.html)  
An workflow for connecting Google Doc writing into the `aggiedown` LaTeX template, allowing for work in Docs with Zotero plug-in to feed directly into an Rmd and BibTeX format.
